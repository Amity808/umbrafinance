      ...
      <main className="max-w-7xl mx-auto px-6 pt-20 pb-32 flex flex-col lg:flex-row items-center justify-between relative z-10">
        <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="https://wa.me/15551234567?text=hi" target="_blank" rel="noopener noreferrer">
                    <button className="px-8 py-4 w-full sm:w-auto bg-[#25D366] hover:bg-[#128C7E] text-white font-bold rounded-lg transition-colors flex items-center justify-center gap-2 shadow-lg shadow-[#25D366]/20">
